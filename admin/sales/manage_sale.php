    ...
    <div class="container-fluid">
        <div class="card card-outline card-outline rounded-0 shadow blur">
            <div class="card-header">
                <h5 class="card-title"><?= isset($id) ? "Update ". $code . " Sale" : "Hóa đơn mới" ?></h5>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                            ...
                            <div class="d-flex h-100 w-100">
                                ...
                                <div class="col-5 h-100">
                                    <table class="table table-bordered table-striped mb-0">
                                        ...
                                        <thead>
                                            <tr class="bg-gradient-navy-dark">
                                                ...
                                                <th class="text-center px-2 py-1">Sản phẩm</th>
                                                <th class="text-center px-2 py-1">Tổng</th>
                                    ...
                                    <h3 class="d-flex w-100 align-items-center">
                                        <div class="col-4">Chiết khấu:</div>
                                        <div class="col-8">
                                    ...
                                    <h3 class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <select name="payment_type" id="payment_type" class="form-control rounded-0" required="required">
                                                ...
                                                <option value="2" <?= isset($payment_type) && $payment_type == 2 ? "selected" : "" ?>>Ví điện tử</option>
                                                <option value="3" <?= isset($payment_type) && $payment_type == 3 ? "selected" : "" ?>>Thẻ</option>
                                            </select>
                                        </div>
                                    </h3>
            ...
            <div class="card-footer py-2 text-right">
                <button class="btn btn-primary rounded-0" form="sale-form">Lưu hóa đơn</button>
                <?php if(!isset($id)): ?>
