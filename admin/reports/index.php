...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Báo cáo hóa đơn hằng ngày</h3>
	</div>
	<div class="card-body">
		<div class="container-fluid">
        <fieldset class="border px-2 mb-2 ,x-2">
            <legend class="w-auto px-2">Bộ lọc</legend>
            <form id="filter-form" action="">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <button class="btn btn-primary rounded-0 btn-sm"><i class="fa fa-filter"></i> Bộ lọc</button>
                            <button class="btn btn-light border rounded-0 btn-sm" type="button" id="print"><i class="fa fa-print"></i> In</button>
                        </div>
                    </div>
                </div>
            </form>
...
<noscript id="print-header">
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center" style="line-height:.9em">
            ...
            <h3 class="text-center m-0"><b>Báo cáo hóa đơn hằng ngày</b></h3>
