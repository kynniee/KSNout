	...
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Tên viết tắt</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Ảnh nền Website</label>
				<div class="custom-file">
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile3">Chọn file</label>
	            </div>
				<small><i>Chọn để cập nhật banner mới</i></small>
			</div>
			<?php 
